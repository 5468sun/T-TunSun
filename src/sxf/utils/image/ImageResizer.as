...
// usage 
// var result:BitmapData = ImageResizer.bilinearIterative(sourceBitmapData, 100, 100,ImageResizeMath.METHOD_PAN_AND_SCAN);
...
package sxf.utils.image
{
    ...
    public class ImageResizer extends Object
    {
        ...
        {
            var scale:Point = ImageResizeMath.scale(
