...
package sxf.comps.antlineselector{
	...
	public class AntLineBox extends Sprite{
		 ...
		 * 
		 * **/
		public function AntLineBox(gap1:int=4,gap2:int=4,color1:int=0x000000,color2:int=0xffffff,thickness:int=1)
		{
			super();
